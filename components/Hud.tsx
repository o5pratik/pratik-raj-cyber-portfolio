...
export default function Hud() {
  return <><header className="hud"><a className="brand" href="#top">P<span>R</span><small>PORTFOLIO // 01</small></a><nav>{links.map(([label, id]) => <a key={id} href={`#${id}`}>{label}</a>)}</nav><div className="online"><b /> ONLINE</div></header>
