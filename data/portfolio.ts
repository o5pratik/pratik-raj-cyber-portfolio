export const skills = [
  { group: "01 // PROGRAMMING", icon: "</>", nodes: [["C", "Low-level logic & foundations"], ["C++", "Efficient systems and DSA"], ["Python", "Automation & problem solving"], ["Java", "Object-oriented development"]] },
  { group: "02 // DEVELOPMENT", icon: "◈", nodes: [["React Native", "Cross-platform mobile interfaces"], ["Android Studio", "Native Android workflows"], ["GitHub", "Version control & collaboration"]] },
  { group: "03 // CREATIVE", icon: "✦", nodes: [["Video Editing", "High-retention visual storytelling"], ["Canva", "Fast, bold visual systems"], ["CapCut", "Social-first content production"]] },
  { group: "04 // MARKETING", icon: "↗", nodes: [["Social Growth", "Audience-first channel growth"], ["Content Strategy", "Ideas built for attention"], ["Branding", "Distinct digital identity"]] },
];
